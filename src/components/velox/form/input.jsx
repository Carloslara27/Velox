function VxInput({type="text",placeholder,required=false,className,id,iconLeft,iconRight}) {
     return (
          <div className="relative w-full">
              {iconLeft && <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                    {iconLeft ?? ""}
